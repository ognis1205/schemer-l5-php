...
use SOkawa\Batch\Support\Boilerplates\SeedingBoilerplate;

/**
 * Represents 'seed' command.
 *
 * @author Shingo OKAWA
 */
class Seed extends Export
{
    /**
     * Holds the command name.
     * @var string
     */
    protected $name = "export:seed";

    /**
     * Holds the command description.
     * @var string
     */
    protected $description = "Generate Seeder implementations from your database.";
    ...
    public function fire()
    {
        ...
        $boilerplate = new SeedingBoilerplate(
        ...
        $message   = [
            "success!",
            "databse seed class generated in: {$output}."
        ];
